class TransportMission extends SurvivorMissions
{
	...
	{		
		...
		MissionObject = ItemBase.Cast( GetGame().CreateObject( "Msp_MilitaryCrate_Brown", m_MissionPosition ));
		
		//Get random loadout 
		int selectedLoadout = Math.RandomIntInclusive( 0, 2);	//!change randomization limit after adding new loadouts!	
		...
		{
			weapon = MissionObject.GetInventory().CreateInInventory("KOD_FAMAS");
			MissionObject.GetInventory().CreateInInventory("Mag_STANAG_30Rnd");
			MissionObject.GetInventory().CreateInInventory("Mag_STANAG_30Rnd");
			MissionObject.GetInventory().CreateInInventory("KOD_HK417");
		...
		{
			weapon = MissionObject.GetInventory().CreateInInventory("KOD_PKM");
		...
		{
			weapon = MissionObject.GetInventory().CreateInInventory("KOD_HK417");
			MissionObject.GetInventory().CreateInInventory("CP_CannabisSeedsPackBlackFrost");
			MissionObject.GetInventory().CreateInInventory("CP_CannabisSeedsPackBlackFrost");
			MissionObject.GetInventory().CreateInInventory("A2FNFAL");
			MissionObject.GetInventory().CreateInInventory("A2FNFAL_Magazine");
			MissionObject.GetInventory().CreateInInventory("A2FNFAL_Magazine");
			MissionObject.GetInventory().CreateInInventory("KOD_R700");
			MissionObject.GetInventory().CreateInInventory("A2M107");
			MissionObject.GetInventory().CreateInInventory("Canteen");
			MissionObject.GetInventory().CreateInInventory("Ap_vip_coin");
		}
		if (selectedLoadout == 3)
		{
			weapon = MissionObject.GetInventory().CreateInInventory("KOD_RSASS_Black");
			MissionObject.GetInventory().CreateInInventory("Mag_KOD_RSASS_20Rnd");
			MissionObject.GetInventory().CreateInInventory("Mag_KOD_RSASS_20Rnd");
			MissionObject.GetInventory().CreateInInventory("Mag_KOD_RSASS_20Rnd");
			MissionObject.GetInventory().CreateInInventory("KOD_R700");
			MissionObject.GetInventory().CreateInInventory("Ap_vip_coin");
